...
#Trabalho 1 da disciplina de Introdução à Programação Python
#João Dartora e Renata Schuster

#(1) Medicamentos Selecionados: ANSIOLÍTICOS
...
#(2) Pesquisa sobre os medicamentos e inclusão em dicionários
...
#(3) Cálculo dos preço médio por comprimido dos medicamentos
...
#(3) Gráfico de preço médio por comprimido dos medicamentos
...
#(3) Cálculo do preço médio da mg do componente principal por medicamento
...
#(3) Gráfico do preço médio da mg do componente principal por medicamento
...
#(4) Gráfico de dose diária x meia vida de eliminação
...
#(5) Cálculo de valor para um tratamento de 7 dias com os medicamentos
...
#(5) Gráfico de valor para um tratamento de 7 dias com os medicamentos
...
#(5) Resultado dos dados coletados para valor de tratamento
...
#(6) Medicamentos que compartilham reações adversas em comum
...
#(7) Inclusão da chave indicando dose diária recomendada para uma criança de 5 anos
ansitec["Dose Criança"] = (5/24)*ansitec["Dose Diaria Em mg Para um Adulto"]
frontal["Dose Criança"] = (5/24)*frontal["Dose Diaria Em mg Para um Adulto"]
lorax["Dose Criança"] = (5/24)*lorax["Dose Diaria Em mg Para um Adulto"]
noctal["Dose Criança"] = (5/24)*noctal["Dose Diaria Em mg Para um Adulto"]
olcadil["Dose Criança"] = (5/24)*olcadil["Dose Diaria Em mg Para um Adulto"]
rivotril["Dose Criança"] = (5/24)*rivotril["Dose Diaria Em mg Para um Adulto"]
somalium["Dose Criança"] = (5/24)*somalium["Dose Diaria Em mg Para um Adulto"]
tranxilene["Dose Criança"] = (5/24)*tranxilene["Dose Diaria Em mg Para um Adulto"]
urbanil["Dose Criança"] = (5/24)*urbanil["Dose Diaria Em mg Para um Adulto"]
valium["Dose Criança"] = (5/24)*valium["Dose Diaria Em mg Para um Adulto"]
